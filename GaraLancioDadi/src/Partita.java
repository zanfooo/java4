public class Partita {
    ...
    private boolean partitaAvanzata;

    public Partita(Giocatore giocatore1, Giocatore giocatore2, int roundTotali, Dado dado) {
    ...
    public void round() {
        if (roundCorrente < roundTotali) {
            ...
            if (lancioGiocatore1 > lancioGiocatore2) {
                ...
                if (!partitaAvanzata){
                    giocatore1.incrementaConsecutive();
                    giocatore2.azzeraConsecutive();
                }
                ...
                if (!partitaAvanzata){
                    giocatore1.azzeraConsecutive();
                    giocatore2.incrementaConsecutive();
                }
            } else {
    ...
    public void setTipopartita(String tipoPartita) {
        if (tipoPartita.equalsIgnoreCase("N")) {
            partitaAvanzata = false;

        } else if (tipoPartita.equalsIgnoreCase("A")) {
            partitaAvanzata = true;
        } else {
            System.out.println("Tipo partita non valido.");
            System.exit(0);
        }
    }
